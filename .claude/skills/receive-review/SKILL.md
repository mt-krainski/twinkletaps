...
IF conflicts with user's prior decisions: Stop and discuss with user
```
...
NOT OK: "You're absolutely right!"
NOT OK: "Thanks for catching that!"
NOT OK: ANY gratitude expression
```
