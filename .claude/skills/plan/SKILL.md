...
**Quality rules:** Read `.claude/docs/quality-checklist.md` and ensure planned implementations comply. Flag any planned approach that would violate a checklist rule.
